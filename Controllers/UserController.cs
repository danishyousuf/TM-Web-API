...
namespace TMCC.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        {
            var isValid = await _userService.VerifyOtpAsync(request.Email, request.Otp);
        ...
        public async Task<IActionResult> ResetPassword([FromBody] ResetPasswordRequestDto request)
        {
            try
            {
                await _userService.ResetPasswordAsync(request.Email, request.Otp, request.NewPassword);
