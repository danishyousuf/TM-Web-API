...
using Microsoft.Identity.Client; // For token acquisition
using System;
...
namespace TMCC.Services
{
    ...
    public class EmailService : IEmailService
    {
            ...
            string entityEmail)
        {
            try
            {
                // 1️⃣ Read client credentials from config
                ...
                {
                    throw new Exception("Email Settings or Azure App secrets missing.");
                }
                // 2️⃣ Acquire token dynamically
