...
namespace TMCC.Services
{
    public class EmployeePaymentHistoryService : IEmployeePaymentHistoryService
    {
        ...
        public Task<int> DeleteEmployeePaymentAsync(Guid paymentId, string deletedBy)
     => _repository.DeleteEmployeePaymentAsync(paymentId, deletedBy);
        public Task<int> DeleteAllPaymentsByEmployeeAsync(Guid empId, string deletedBy)
    => _repository.DeleteAllPaymentsByEmployeeAsync(empId, deletedBy);
