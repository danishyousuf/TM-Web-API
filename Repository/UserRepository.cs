...
namespace TMCC.Repository
{
    public class UserRepository : IUserRepository
    {
        ...
        public async Task<int> UpdatePasswordAsync(string email, string passwordHash)
        {
            var parameters = new DynamicParameters();
            parameters.Add("p_email", email);
            parameters.Add("p_password_hash", passwordHash);

            return await _dapperHelper.ExecuteNonQueryAsync("sp_UpdateUserPassword", parameters);
        }
        public async Task SaveOtpAsync(string email, string otp, DateTime expiry)
        {
            ...
            await _dapperHelper.ExecuteNonQueryAsync("sp_SaveOtp", parameters);
        }
        ...
        public async Task<(string Otp, DateTime Expiry)?> GetOtpAsync(string email)
        {
            ...
            return (result.otp, result.expiry);
        }
        ...
        public async Task DeleteOtpAsync(string email)
        {
            ...
            await _dapperHelper.ExecuteNonQueryAsync("sp_DeleteOtp", parameters);
        }
